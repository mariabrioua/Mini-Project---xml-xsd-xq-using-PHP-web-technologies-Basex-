(: updates.xq : Fichier des mises à jour XQuery Update :)
...
into doc("club.xml")/club/membres
...
doc("club.xml")/club/concours/concours[@id="CO2"]/@coefficient
with "2.0"
...
delete node
doc("club.xml")/club/concours/concours[@id="CO1"]/participants/participant[@membreRef="M001"] 